...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-900 to-indigo-800 text-gray-200 pt-10 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        
        {/* About Section */}
        <div>
          <h3 className="flex items-center text-lg font-bold text-yellow-400 gap-2 mb-3">
            <ToolCase size={22} />
            BritFix
          </h3>
      ...
      {/* Bottom */}
      <div className="mt-10 border-t border-white/10 pt-4 text-center text-sm text-gray-300">
